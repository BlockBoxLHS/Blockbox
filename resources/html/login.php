    ...
    <body>
        ...
        <div class="login-form">
            ...
            <div class="login-form-info">
                ...
                <input form="LoginForm" type="text" name="Username" placeholder="Username"><br>
                <p style="color: red;"><?php echo $errorPassword; ?></p>
                <input form="LoginForm" type="password" name="Password" placeholder="Password"><br>
                <input form="LoginForm" type="submit" value="Login">
            </div>
        ...
        <form id="LoginForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST"></form>
        <?php
